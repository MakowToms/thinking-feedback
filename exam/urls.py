...
from .views import (
    choose_stage, create_test, manage_test, create_student_test, manage_student_test, generate_test, generate_test_api, generate_student_test,
)
...
urlpatterns = [
    ...
    path("api/generate/", generate_test_api),
